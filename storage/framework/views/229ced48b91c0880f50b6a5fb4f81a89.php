...
} elseif ($_instance->childHasBeenRendered('7Ynpji3')) {
    $componentId = $_instance->getRenderedChildComponentId('7Ynpji3');
    $componentTag = $_instance->getRenderedChildComponentTagName('7Ynpji3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7Ynpji3');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('7Ynpji3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('ub7afvB')) {
    $componentId = $_instance->getRenderedChildComponentId('ub7afvB');
    $componentTag = $_instance->getRenderedChildComponentTagName('ub7afvB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ub7afvB');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('ub7afvB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\namor\ACI\vendor\filament\filament\resources\views/components/topbar.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('tUD6aDZ')) {
    $componentId = $_instance->getRenderedChildComponentId('tUD6aDZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('tUD6aDZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tUD6aDZ');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('tUD6aDZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\namor\ACI\vendor\filament\filament\resources\views/components/layouts/card.blade.php ENDPATH**/ ?>
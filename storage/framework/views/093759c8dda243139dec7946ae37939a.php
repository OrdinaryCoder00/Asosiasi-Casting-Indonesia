                    ...
                    <div class="poster-card-col">
                        <div class="poster-card" data-card-id="<?php echo e($item['id'] ?? $loop->index); ?>">
                            ...
                            <div class="poster-info-overlay">
                                <h5 class="poster-title"><?php echo e($item['Nama_Film']); ?></h5>
        ...
        <div class="modal-dialog modal-xl modal-xl-custom modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h3 class="modal-title" id="filmModalLabel<?php echo e($item['id'] ?? $loop->index); ?>">Film Details</h3>
                            ...
                            <div class="modal-film-content">
                                ...
                                <div class="modal-film-footer d-flex justify-content-between align-items-center">
                                    <div class="footer-item">
                                        ...
                                        <p class="footer-value"><?php echo e($item['nama_casting_director'] ?? 'N/A'); ?></p>
                                    </div>

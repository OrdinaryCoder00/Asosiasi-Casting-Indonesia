...
<?php foreach($attributes->onlyProps(['film']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['film']); ?>
<?php foreach (array_filter((['film']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
        ...
        <div class="poster-scroll-container" id="filmPosterCarousel">
            ...
            <?php $__currentLoopData = $film; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="poster-card-col" data-original="true">
                    <div class="poster-card" data-card-id="<?php echo e($item['id'] ?? $loop->index); ?>">
                        <div class="poster-card-image-wrapper">
                            <img src="<?php echo e($item['image']); ?>" alt="<?php echo e($item['Nama_Film']); ?>">
                        </div>
                        <div class="poster-info-overlay">
                            <h4 class="poster-title border-bottom"><?php echo e($item['Nama_Film']); ?></h4>
                            <p class="poster-description"><?php echo e($item['Deskripsi_singkat']); ?></p>
                            <a href="#" class="btn-read-more" data-bs-toggle="modal"
                                data-bs-target="#filmModal<?php echo e($item['id'] ?? $loop->index); ?>">
...
<?php $__currentLoopData = $film; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade" id="filmModal<?php echo e($item['id'] ?? $loop->index); ?>" tabindex="-1"
        aria-labelledby="filmModalLabel<?php echo e($item['id'] ?? $loop->index); ?>" aria-hidden="true">
                ...
                <div class="modal-body modal-body-custom">
                    ...
                    <div class="row g-0 h-lg-100 film-modal-row ">
                        <div class="col-md-5 img-wrapper d-none d-md-block">
                            <img src="<?php echo e($item['image']); ?>" alt="<?php echo e($item['Nama_Film']); ?>" class="modal-film-poster">
                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="modal-film-content">
                                ...
                                <div class="modal-film-title">
                                    <h2><?php echo e($item['Nama_Film']); ?></h2>
                                </div>
                                <div class="modal-film-description">
                                    <p><?php echo e($item['Deskripsi_lengkap'] ?? $item['Deskripsi_singkat']); ?></p>
                                </div>
                                ...
                                <div class="modal-film-footer">
                                    <div class="footer-item">
                                        ...
                                        <p class="footer-value">
                                            <?php echo e($item['nama_casting_director'] ?? 'N/A'); ?></p>
                                    </div>
                                    <div class="footer-item text-end">
                                        <div class="footer-label">Read More :</div>
                                        <p class="footer-value">
                                            <a href="#" class="footer-link">
                                                <?php echo e($item['nama_casting_director'] ?? 'N/A'); ?>
...
<?php /**PATH C:\Users\namor\ACI\resources\views/components/home/film.blade.php ENDPATH**/ ?>
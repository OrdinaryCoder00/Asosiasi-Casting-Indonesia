                ...
                <div class="card-col" data-original="true">
                    <div class="team-card" data-card-id="<?php echo e($data['id']); ?>">
                        ...
                        <div class="card-overlay">
                            <h4 class="border-bottom"><?php echo e($data['nama']); ?></h4>
                ...
                <div class="modal-body modal-body-custom ">
                    ...
                    <div class="row g-0 member-modal-row">
                        <div class="col-12 col-md-5 position-relative d-lg-block d-none ">
                            <img src="<?php echo e($data['image']); ?>" alt="<?php echo e($data['nama']); ?>" class="modal-left-image">
                                        ...
                                        <?php if(isset($data['portfolio']) && count($data['portfolio']) > 0): ?>
                                            <?php $__currentLoopData = $data['portfolio']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $portfolio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="portfolio-card">
                                                    <img src="<?php echo e($portfolio['poster']); ?>"
                                                        alt="<?php echo e($portfolio['judul']); ?>">
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
